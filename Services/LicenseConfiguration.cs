...
internal static class ProductionLicenseConfiguration
{
    ...
    public const string DefaultProductionVaultEndpointUrl = "https://api.sandboxtimeline.app/v1/license/validate";
...
internal static class DeveloperLicenseResetPolicy
{
    ...
    /// </summary>
    public static readonly bool ForceClearStoredLicenseOnStartup = true;
}
#endif
